...
<div class="container">
    <?php if ($siswa_id > 0 && $kelas_id > 0): ?>
        <a href="../dwi/kelas_detail.php?id=<?php echo $kelas_id; ?>" style="display:inline-block; margin-bottom: 20px; color: var(--text-secondary); text-decoration: none;"><i class="fa-solid fa-arrow-left"></i> Kembali ke Detail Kelas</a>
    <?php endif; ?>
    ...
    <?php if (isset($_SESSION['admin_user'])): ?>
        <a href="../veve/index.php" style="text-decoration:none;"><button class="btn-secondary" type="button"><i class="fa-solid fa-house" style="margin-right: 6px;"></i>Ke Dasbor Admin</button></a>
    <?php elseif (isset($_SESSION['siswa_user'])): ?>
        <a href="../veve/siswa_dashboard.php" style="text-decoration:none;"><button class="btn-secondary" type="button"><i class="fa-solid fa-house" style="margin-right: 6px;"></i>Ke Portal Siswa</button></a>
    <?php else: ?>
        <a href="../desta/login.php" style="text-decoration:none;"><button class="btn-secondary" type="button"><i class="fa-solid fa-right-to-bracket" style="margin-right: 6px;"></i>Ke Halaman Login</button></a>
    <?php endif; ?>
    <a href="../fiis/absensi.php" style="text-decoration:none;"><button class="btn-secondary" type="button" style="margin-top: 5px;"><i class="fa-solid fa-camera-retro" style="margin-right: 6px;"></i>Ke Halaman Absensi</button></a>
