...
<div class="container">
    ...
    <?php if (isset($_SESSION['admin_user'])): ?>
        <a href="../veve/index.php" style="text-decoration:none; display: block; width: 100%;">
    ...
    <?php else: ?>
        <a href="../veve/siswa_dashboard.php" style="text-decoration:none; display: block; width: 100%;">
