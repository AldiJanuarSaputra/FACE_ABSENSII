...
if (isset($_SESSION['admin_user'])) {
    header("Location: ../veve/index.php");
    exit;
} elseif (isset($_SESSION['siswa_user'])) {
    header("Location: ../veve/siswa_dashboard.php");
    exit;
}
...
<div class="login-container">
    ...
    <div style="margin-top: 20px; font-size: 13px; color: var(--text-secondary);">
        Belum terdaftar? 
        <a href="../fiis/register.php" id="register-link" style="color: var(--primary); text-decoration: none; font-weight: 600; transition: all 0.3s ease; margin-left: 4px;">Daftarkan Wajah (Face ID) Siswa</a>
    </div>
</div>
...
function updateLabels(role) {
    ...
    if (role === 'siswa') {
        ...
        regLink.href = "../fiis/register.php";
