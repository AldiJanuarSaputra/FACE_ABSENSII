    ...
    <main class="main-content">
        ...
        <div class="filter-wrap" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
            <form method="GET" class="filter-form" style="margin: 0; flex: 1;">
                ...
                <?php if ($cari !== ''): ?>
                    <a href="../dwi/kelas.php" class="btn-reset" style="padding: 12px 18px;"><i class="fa-solid fa-rotate-left" style="margin-right: 6px;"></i>Reset</a>
                <?php endif; ?>
            </form>
                        ...
                        <?php foreach ($listKelas as $row): ?>
                            <tr>
                                ...
                                <td style="text-align: center; display: flex; justify-content: center; gap: 8px; flex-wrap: wrap; border-bottom: none;">
                                    <a href="../dwi/kelas_detail.php?id=<?php echo $row['id']; ?>" class="btn-edit" style="background: rgba(99, 102, 241, 0.12); color: var(--primary); border: 1px solid rgba(99, 102, 241, 0.2); text-decoration: none; padding: 6px 12px; margin: 0; display: inline-flex; align-items: center;">
