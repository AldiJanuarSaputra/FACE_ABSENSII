        ...
        <div>
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item active" style="margin-top: 15px; border-top: 1px solid var(--sidebar-border); padding-top: 15px;">
                    <a href="database_console.php" style="color: var(--primary);"><i class="fa-solid fa-database"></i>Konsol Database</a>
                </li>
                <li class="menu-item">
                    <a href="absensi.php" style="color: #6366f1;"><i class="fa-solid fa-camera"></i>Scan Kehadiran</a>
                </li>
                <li class="menu-item">
                    <a href="register.php" style="color: #0ea5e9;"><i class="fa-solid fa-user-plus"></i>Registrasi Wajah</a>
                </li>
            </ul>
        </div>
